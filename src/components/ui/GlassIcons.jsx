...
export function BookOpenGlass({ size = 24, className = '' }) {
  const id = useId().replace(/:/g, '')
  const gradA = `grad-book-a-${id}`
  const gradE = `grad-book-e-${id}`
  const gradF = `grad-book-f-${id}`
  const clipD = `clip-book-d-${id}`
  const filterC = `filter-book-c-${id}`
  const maskB = `mask-book-b-${id}`
    ...
    >
      ...
      <g fill="none">
        ...
        <defs>
          ...
          <clipPath id={clipD}>
            <path d="M17.106 2.865c1.331-.296 1.997-.443 2.52-.271a2 2 0 0 1 1.093.876C21 3.943 21 4.625 21 5.99v8.443c0 .916 0 1.374-.162 1.752a2.001 2.001 0 0 1-.669.833c-.334.24-.78.34-1.675.539l-6.147 1.366a2.09 2.09 0 0 1-.26.049 1 1 0 0 1-.174 0 2.09 2.09 0 0 1-.26-.05l-6.147-1.365c-.894-.199-1.341-.298-1.675-.539a2 2 0 0 1-.669-.833C3 15.807 3 15.349 3 14.433V5.99c0-1.364 0-2.046.281-2.519a2 2 0 0 1 1.093-.876c.523-.172 1.189-.025 2.52.271l4.759 1.058c.13.029.194.043.26.049a1 1 0 0 0 .174 0c.066-.006.13-.02.26-.05l4.759-1.057Z" />
          </clipPath>
          <filter id={filterC} width="400%" height="400%" x="-100%" y="-100%" filterUnits="objectBoundingBox">
            <feGaussianBlur in="SourceGraphic" result="blur" stdDeviation="2" />
          </filter>
          <mask id={maskB}>
            <rect width="100%" height="100%" fill="#FFF" />
            <path fill="#000" d="M17.106 2.865c1.331-.296 1.997-.443 2.52-.271a2 2 0 0 1 1.093.876C21 3.943 21 4.625 21 5.99v8.443c0 .916 0 1.374-.162 1.752a2.001 2.001 0 0 1-.669.833c-.334.24-.78.34-1.675.539l-6.147 1.366a2.09 2.09 0 0 1-.26.049 1 1 0 0 1-.174 0 2.09 2.09 0 0 1-.26-.05l-6.147-1.365c-.894-.199-1.341-.298-1.675-.539a2 2 0 0 1-.669-.833C3 15.807 3 15.349 3 14.433V5.99c0-1.364 0-2.046.281-2.519a2 2 0 0 1 1.093-.876c.523-.172 1.189-.025 2.52.271l4.759 1.058c.13.029.194.043.26.049a1 1 0 0 0 .174 0c.066-.006.13-.02.26-.05l4.759-1.057Z" />
          </mask>
        </defs>
      </g>
    </svg>
...
export function AwardGlass({ size = 24, className = '' }) {
  const id = useId().replace(/:/g, '')
  const gradA = `grad-award-a-${id}`
  const gradE = `grad-award-e-${id}`
  const gradF = `grad-award-f-${id}`
  const clipD = `clip-award-d-${id}`
  const filterC = `filter-award-c-${id}`
  const maskB = `mask-award-b-${id}`
  ...
  return (
    ...
    >
      ...
      <g fill="none">
        ...
        />
        <defs>
          <linearGradient id={gradA} x1="12" x2="12" y1="-0.5" y2="23.126" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FFB800" stopOpacity="0.9" />
            <stop offset="1" stopColor="#1E1402" />
          </linearGradient>
          <linearGradient id={gradE} x1="12" x2="12" y1="1" y2="18" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FFD700" stopOpacity="0.7" />
            <stop offset="1" stopColor="#FF8800" stopOpacity="0.4" />
          </linearGradient>
          <linearGradient id={gradF} x1="12" x2="12" y1="1" y2="10.845" gradientUnits="userSpaceOnUse">
            <stop stopColor="#fff" />
            <stop offset="1" stopColor="#fff" stopOpacity="0" />
          </linearGradient>
          <clipPath id={clipD}>
            <path d="M12 1a8.5 8.5 0 1 1 0 17 8.5 8.5 0 0 1 0-17Z" />
          </clipPath>
          <filter id={filterC} width="400%" height="400%" x="-100%" y="-100%" filterUnits="objectBoundingBox">
            <feGaussianBlur in="SourceGraphic" result="blur" stdDeviation="2" />
          </filter>
...
export function CalendarGlass({ size = 24, className = '' }) {
  const id = useId().replace(/:/g, '')
  const gradA = `grad-cal-a-${id}`
  const gradE = `grad-cal-e-${id}`
  const gradF = `grad-cal-f-${id}`
  const clipD = `clip-cal-d-${id}`
  const filterC = `filter-cal-c-${id}`
  const maskB = `mask-cal-b-${id}`
  ...
  return (
    ...
    >
      ...
      <g fill="none">
        ...
        />
        <defs>
          <linearGradient id={gradA} x1="12" x2="12" y1="-2" y2="19.495" gradientUnits="userSpaceOnUse">
            <stop stopColor="#00FF88" stopOpacity="0.8" />
            <stop offset="1" stopColor="#042014" />
          </linearGradient>
...
export function CartGlass({ size = 24, className = '' }) {
  const id = useId().replace(/:/g, '')
  const gradA = `grad-cart-a-${id}`
  const gradE = `grad-cart-e-${id}`
  const gradF = `grad-cart-f-${id}`
  const gradG = `grad-cart-g-${id}`
  const gradH = `grad-cart-h-${id}`
  const clipD = `clip-cart-d-${id}`
  const filterC = `filter-cart-c-${id}`
  const maskB = `mask-cart-b-${id}`
    ...
    >
      ...
      <g fill="none">
        ...
        <path
          ...
          filter={`url(#${filterC})`}
        />
        <path fill={`url(#${gradE})`} d="M3 21a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z" />
        <path fill={`url(#${gradF})`} d="M17 21a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z" />
        <path
          fill={`url(#${gradG})`}
        ...
        />
        <defs>
          <linearGradient id={gradA} x1="13.011" x2="13.011" y1="1.243" y2="12.757" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id={gradH} x1="14" x2="11.5" y1="5" y2="9.5" gradientUnits="userSpaceOnUse">
            <stop stopColor="#fff" />
            <stop offset="1" stopColor="#fff" stopOpacity="0" />
          </linearGradient>
          <clipPath id={clipD}>
            <path d="M1.266 1a3 3 0 0 1 2.97 2.576L4.437 5h15.545a2 2 0 0 1 1.949 2.452l-1.47 6.332A4 4 0 0 1 16.54 17H7.602a4 4 0 0 1-3.96-3.435L2.58 6.142l-.002-.017-.324-2.267A1 1 0 0 0 1.265 3H1a1 1 0 0 1 0-2h.266Z" />
          </clipPath>
          <filter id={filterC} width="400%" height="400%" x="-100%" y="-100%" filterUnits="objectBoundingBox">
            <feGaussianBlur in="SourceGraphic" result="blur" stdDeviation="2" />
          </filter>
          <mask id={maskB}>
            <rect width="100%" height="100%" fill="#FFF" />
            <path fill="#000" d="M1.266 1a3 3 0 0 1 2.97 2.576L4.437 5h15.545a2 2 0 0 1 1.949 2.452l-1.47 6.332A4 4 0 0 1 16.54 17H7.602a4 4 0 0 1-3.96-3.435L2.58 6.142l-.002-.017-.324-2.267A1 1 0 0 0 1.265 3H1a1 1 0 0 1 0-2h.266Z" />
          </mask>
        </defs>
      </g>
    </svg>
...
export function CodeEditorGlass({ size = 24, className = '' }) {
  const id = useId().replace(/:/g, '')
  const gradA = `grad-code-a-${id}`
  const gradE = `grad-code-e-${id}`
  const gradF = `grad-code-f-${id}`
  const clipD = `clip-code-d-${id}`
  const filterC = `filter-code-c-${id}`
  const maskB = `mask-code-b-${id}`
  ...
  return (
    ...
    >
      ...
      <g fill="none">
        ...
        />
        <defs>
          <linearGradient id={gradA} x1="11.25" x2="11.25" y1="3" y2="21" gradientUnits="userSpaceOnUse">
          ...
          <clipPath id={clipD}>
            <path d="M16.6 3c2.24 0 3.36 0 4.216.436a4.001 4.001 0 0 1 1.748 1.748C23 6.039 23 7.16 23 9.4v5.2c0 2.24 0 3.36-.436 4.216a4.002 4.002 0 0 1-1.748 1.748C19.961 21 18.84 21 16.6 21h-5.2c-2.24 0-3.36 0-4.216-.436a4.001 4.001 0 0 1-1.748-1.748C5 17.961 5 16.84 5 14.6V9.4c0-2.24 0-3.36.436-4.216a4.001 4.001 0 0 1 1.748-1.748C8.039 3 9.16 3 11.4 3h5.2ZM13 16a1 1 0 1 0 0 2h2a1 1 0 1 0 0-2h-2Zm2-3.5a1 1 0 1 0 0 2h5a1 1 0 1 0 0-2h-5ZM13 9a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2h-3ZM9 6a1 1 0 0 0 0 2h1a1 1 0 1 0 0-2H9Z" />
          </clipPath>
          <filter id={filterC} width="400%" height="400%" x="-100%" y="-100%" filterUnits="objectBoundingBox">
            <feGaussianBlur in="SourceGraphic" result="blur" stdDeviation="2" />
          </filter>
...
export function WalletGlass({ size = 24, className = '' }) {
  const id = useId().replace(/:/g, '')
  const gradA = `grad-wal-a-${id}`
  const gradE = `grad-wal-e-${id}`
  const gradF = `grad-wal-f-${id}`
  const gradG = `grad-wal-g-${id}`
  const clipD = `clip-wal-d-${id}`
  const filterC = `filter-wal-c-${id}`
  const maskB = `mask-wal-b-${id}`
    ...
    >
      ...
      <g fill="none">
        ...
        <defs>
          ...
          <linearGradient id={gradG} x1="19" x2="19" y1="10" y2="17" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FF2E5B" stopOpacity="0.9" />
            <stop offset="1" stopColor="#330A14" />
          </linearGradient>
          <clipPath id={clipD}>
            <path d="M15.6 5c2.24 0 3.36 0 4.216.436a4 4 0 0 1 1.748 1.748C22 8.04 22 9.16 22 11.4v4.2c0 2.24 0 3.36-.436 4.216a4 4 0 0 1-1.748 1.748C18.96 22 17.84 22 15.6 22H8.4c-2.24 0-3.36 0-4.216-.436a4 4 0 0 1-1.748-1.748C2 18.96 2 17.84 2 15.6v-4.2c0-2.24 0-3.36.436-4.216a4 4 0 0 1 1.748-1.748C5.04 5 6.16 5 8.4 5h7.2Z" />
          </clipPath>
          <filter id={filterC} width="400%" height="400%" x="-100%" y="-100%" filterUnits="objectBoundingBox">
            <feGaussianBlur in="SourceGraphic" result="blur" stdDeviation="2" />
          </filter>
          <mask id={maskB}>
            <rect width="100%" height="100%" fill="#FFF" />
            <path fill="#000" d="M15.6 5c2.24 0 3.36 0 4.216.436a4 4 0 0 1 1.748 1.748C22 8.04 22 9.16 22 11.4v4.2c0 2.24 0 3.36-.436 4.216a4 4 0 0 1-1.748 1.748C18.96 22 17.84 22 15.6 22H8.4c-2.24 0-3.36 0-4.216-.436a4 4 0 0 1-1.748-1.748C2 18.96 2 17.84 2 15.6v-4.2c0-2.24 0-3.36.436-4.216a4 4 0 0 1 1.748-1.748C5.04 5 6.16 5 8.4 5h7.2Z" />
          </mask>
        </defs>
      </g>
    </svg>
